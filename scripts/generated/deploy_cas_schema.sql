-- COMPREHENSIVE CAS DATABASE DEPLOYMENT SCRIPT
-- Generated from Oracle CAS Migration
-- Execute this script in PostgreSQL to deploy the entire CAS schema and data
--
-- Usage: psql -U postgres -f deploy_cas_full.sql
-- Or in PostgreSQL shell: \i deploy_cas_full.sql
...
-- ============================================================================
-- Note: If cas_db already exists, comment out or skip the CREATE DATABASE line

CREATE DATABASE cas_db OWNER postgres;
\connect cas_db
...
-- ============================================================================
-- SECTION 2: CREATE ORACLE COMPATIBILITY HELPER FUNCTIONS
-- ============================================================================

-- sysdate function (returns current timestamp)
CREATE OR REPLACE FUNCTION oracle_compat.sysdate() RETURNS timestamp AS $$
BEGIN
  RETURN CURRENT_TIMESTAMP;
END;
$$ LANGUAGE plpgsql IMMUTABLE;

-- get_cas_sys_dt function
CREATE OR REPLACE FUNCTION cas.get_cas_sys_dt() RETURNS timestamp AS $$
BEGIN
  RETURN CURRENT_TIMESTAMP;
END;
$$ LANGUAGE plpgsql IMMUTABLE;
...
-- ============================================================================
-- SECTION 3: CREATE CONTROL PARAMETERS TABLE AND FUNCTIONS
-- ============================================================================
-- Note: This compatibility table is renamed to avoid conflict with actual tcontrol_parameters

CREATE TABLE IF NOT EXISTS cas.tcontrol_parameters_compat (
  ctl_parm_id varchar(50) PRIMARY KEY,
  ctl_parm_val text,
  ctl_parm_num numeric,
  ctl_parm_dt timestamp,
  ctl_parm_comments text
);

CREATE OR REPLACE FUNCTION cas.ctl_parm_get_text(p_parm_id varchar) RETURNS text AS $$
BEGIN
  RETURN (SELECT ctl_parm_val FROM cas.tcontrol_parameters_compat WHERE ctl_parm_id = p_parm_id);
END;
$$ LANGUAGE plpgsql STABLE;

CREATE OR REPLACE FUNCTION cas.ctl_parm_get_num(p_parm_id varchar) RETURNS numeric AS $$
BEGIN
  RETURN (SELECT ctl_parm_num FROM cas.tcontrol_parameters_compat WHERE ctl_parm_id = p_parm_id);
END;
$$ LANGUAGE plpgsql STABLE;
...
CREATE SEQUENCE IF NOT EXISTS cas.acct_link_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.aex_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.alpha_search_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.case_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.cas_log_id START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.cli_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.clm_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.pol_num_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.req_num_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.trxn_num_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS cas.zap_log_seq START WITH 1 INCREMENT BY 1;

-- ============================================================================
-- SECTION 5: CREATE APPLICATION TABLES
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS cas.td4exmr_examiner_master (
    ...
    examiner_nm varchar(600) not null,
...
INSERT INTO cas.oracle_migration_backlog (object_name, object_type, status, notes) VALUES
  ('CTL_PARM', 'PACKAGE', 'pending', 'Package implementation needed'),
  ('PKG_MIT#TH', 'PACKAGE', 'pending', 'Package implementation needed'),
  ('CSMS_PROC_DUMMY', 'PROCEDURE', 'pending', 'Synonym replacement or procedure needed'),
  ('TPLAN_TERM_MAPPINGS', 'TABLE', 'pending', 'Table creation may be prioritized');
...
-- ============================================================================
-- Summary of deployed schema objects:
-- - Tables: 1340
-- - Indexes: 292
-- - Sequences: 11
-- - Functions: 4

-- Next step: Run deploy_cas_data.sql to insert master data
