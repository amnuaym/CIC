...
You are an Explorer subagent (Finalization Explorer 3). Your working directory is D:\Github\cic\.agents\explorer_finalization_3\.
...
Do not write or modify any files directly. Write your findings and recommended file changes to D:\Github\cic\.agents\explorer_finalization_3\analysis.md and send a message back to the orchestrator (da8ce0a2-5eb5-466e-bbc7-abdcaeb034c7) with the report path when done.
